(ns ingest.datomic
  ...
  ```
  clojure -A:ingest:datomic -m ingest.datomic <db-name> <datomic-client-config-edn>
  ```"
...
(defn- usage [options-summary]
  (fmt-desc
   ["Ingest schema into Schema Voyager from a running Datomic database."
    ""
    "Usage: clojure -A:ingest:datomic -m ingest.datomic [options] db-name datomic-client-config-edn"
    ""
